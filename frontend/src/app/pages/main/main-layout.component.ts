...
export class MainLayoutComponent implements OnInit, OnDestroy {
  ...
  primaryMenuItems: MenuItem[] = [
    ...
    { icon: 'contact_phone', label: 'Escalamiento', route: '/main/escalation/view', roles: ['admin', 'user', 'guest'] },
  ...
  configItems: MenuItem[] = [
    ...
    { icon: 'admin_panel_settings', label: 'Admin Escalamiento', route: '/main/escalation/admin', roles: ['admin'] },
